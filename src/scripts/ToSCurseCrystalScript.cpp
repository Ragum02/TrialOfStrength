...
bool ToSCurseCrystalScript::OnGossipHello(Player* player, GameObject* go)
{
    ...
    AddGossipItemFor(player, GOSSIP_ICON_CHAT, Acore::StringFormat("|cff000000{}|n|cff212121{}|r|n{}", curseInfo->name, curseInfo->description, sToSMapMgr->GetDifficultyString(curseInfo->difficulty)), GOSSIP_SENDER_MAIN, curseInfo->id);
